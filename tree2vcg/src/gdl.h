...
#define DEF_ACCESS_ATTR(obj, attribute, type) \
static inline type \
get_##obj##_##attribute (struct gdl_##obj *obj) \
{ \
  return obj->attr.attribute; \
} \
 \
static inline void \
set_##obj##_##attribute (struct gdl_##obj *obj, type value) \
{ \
  obj->attr.attribute = value; \
}

DEF_ACCESS_ATTR(node, title, char *)
DEF_ACCESS_ATTR(node, label, char *)
